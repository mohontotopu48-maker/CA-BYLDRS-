          ...
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {trades.map((trade) => (
              <StaggerItem key={trade}>
                <div className="bg-[#16253D] rounded-2xl border border-[rgba(94,182,240,0.1)] shadow-sm p-6 text-center hover:shadow-[0_4px_24px_rgba(94,182,240,0.08)] transition-shadow duration-300">
                  <div className="w-12 h-12 rounded-full bg-[rgba(94,182,240,0.08)] flex items-center justify-center mx-auto mb-3">
                    <HardHat className="w-6 h-6 text-[#5EB6F0]" />
                  </div>
      ...
      <section className="py-16 md:py-24 bg-[#0F1A2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#F0F4F8] leading-tight tracking-tight mb-4">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto">
            <StaggerItem>
              <div className="bg-[#5EB6F0] rounded-2xl p-8 h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
                    <Video className="w-6 h-6 text-[#0F1A2E]" />
                  </div>
                  <span className="text-xs font-semibold tracking-widest uppercase text-[#0F1A2E]/70">
                    The CA BYLDRS Solution
                  </span>
                </div>
                <p className="text-base text-[#0F1A2E]/90 leading-relaxed">
            ...
            <StaggerItem>
              <div className="bg-[#0D1754] rounded-2xl p-8 h-full">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-[rgba(94,182,240,0.08)] flex items-center justify-center">
                    <Award className="w-6 h-6 text-[#5EB6F0]" />
                  </div>
                  <span className="text-xs font-semibold tracking-widest uppercase text-[#5EB6F0]">
                    How We Help
                  </span>
                </div>
                <p className="text-base text-[#B0C4DE] leading-relaxed">
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
            <StaggerItem>
              <div className="bg-[#16253D] rounded-2xl border border-[rgba(94,182,240,0.1)] shadow-sm p-6 text-center">
                <p className="text-lg font-bold text-[#F0F4F8]">3 Weeks to Authority</p>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-[#16253D] rounded-2xl border border-[rgba(94,182,240,0.1)] shadow-sm p-6 text-center">
                <p className="text-lg font-bold text-[#F0F4F8]">Professional Production</p>
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-[#16253D] rounded-2xl border border-[rgba(94,182,240,0.1)] shadow-sm p-6 text-center">
                <p className="text-lg font-bold text-[#F0F4F8]">Profile + Social + Web</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
      ...
      <section className="py-16 md:py-24 bg-[#0F1A2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <div className="bg-[rgba(94,182,240,0.08)] rounded-2xl p-8 text-center flex-1 max-w-sm w-full">
              <MapPin className="w-8 h-8 text-[#5EB6F0] mx-auto mb-3" />
