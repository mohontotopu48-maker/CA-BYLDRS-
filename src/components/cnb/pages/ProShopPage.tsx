    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="hero-gradient pt-28 pb-16 md:pt-36 md:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1D1D1F] leading-tight tracking-tight mb-6">
              Guardian Pro-Shop: Dress for the{' '}
              <span className="text-[#1A237E]">Elite Status</span> You've
              Earned.
            </h1>
            <p className="text-lg text-[#6E6E73] max-w-2xl mx-auto leading-relaxed mb-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#E8EAF6] border border-[#1A237E]/10">
            ...
            {products.map((product) => {
              ...
              return (
                <StaggerItem key={product.id}>
                  <div className="bg-white rounded-2xl border border-black/[0.08] shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 h-full flex flex-col">
                    {/* Product Visual */}
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <span className="text-xs font-mono font-bold text-[#1A237E]/40">
                          #{product.id}
                        </span>
                        {isAlphaExclusive ? (
                          <span className="inline-flex items-center gap-1 text-[10px] font-semibold tracking-wide uppercase px-2.5 py-1 rounded-full bg-[#D4AF37]/10 text-[#9A7B2A] border border-[#D4AF37]/20">
                            <Sparkles className="w-3 h-3" />
                            {product.badge}
                          </span>
                        ) : (
                          <span className="text-[10px] font-semibold tracking-wide uppercase px-2.5 py-1 rounded-full bg-[#F5F5F7] text-[#6E6E73] border border-black/[0.06]">
                            {product.badge}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="mt-4 pt-3 border-t border-black/[0.06]">
                        <div className="flex items-center gap-2 text-xs text-[#1A237E] font-medium">
      ...
      <section className="py-16 md:py-24 bg-[#F5F5F7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {stats.map((stat) => (
              <StaggerItem key={stat.value}>
                <div className="bg-white rounded-2xl border border-black/[0.08] shadow-sm p-8 text-center hover:shadow-md transition-shadow duration-300">
                  <p className="text-4xl sm:text-5xl font-bold text-[#1A237E] mb-3">
                    {stat.value}
                  </p>
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-center text-[#6E6E73] max-w-2xl mx-auto mt-10 text-base leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="rounded-2xl border border-black/[0.08] bg-[#F5F5F7] p-8 sm:p-10 flex flex-col sm:flex-row gap-6 items-start">
              <div className="w-12 h-12 rounded-xl bg-[#E8EAF6] flex items-center justify-center shrink-0">
                <Tag className="w-6 h-6 text-[#1A237E]" />
              </div>
              <div>
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-[#1A237E]/30 text-[#1A237E] font-semibold px-8 h-12 text-base rounded-full hover:bg-[#1A237E]/[0.06] hover:border-[#1A237E] cursor-pointer"
              >
