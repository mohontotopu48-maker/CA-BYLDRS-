    ...
    <section className="py-20 md:py-28 bg-[#F5F5F7]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {partnershipPhases.map((phase, index) => (
            <StaggerItem key={phase.phase}>
              <div className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-8 h-full shadow-[0_1px_8px_rgba(0,0,0,0.03)]">
                {/* Phase Badge */}
                <span className="inline-block px-4 py-1.5 rounded-full bg-[#1A237E] text-white text-xs font-bold tracking-wider mb-6">
                  PHASE {phase.phase}
                </span>
                ...
                <ul className="space-y-3">
                  {phase.highlights.map((highlight, hi) => (
                    <li key={hi} className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-[#E8EAF6] flex items-center justify-center mt-0.5 shrink-0">
                        <Check className="w-3 h-3 text-[#1A237E]" />
                      </div>
        ...
        <div className="hidden md:flex justify-center -mt-10 mb-10 relative z-10">
          <div className="w-12 h-12 rounded-full bg-[#1A237E] flex items-center justify-center shadow-md">
        ...
        <div className="flex md:hidden justify-center mb-10">
          <div className="w-10 h-10 rounded-full bg-[#1A237E] flex items-center justify-center shadow-md rotate-90">
